...
class User(AbstractUser):
    user_role = models.IntegerField(choices=UserRoles.choices, default=UserRoles.ADMIN)
    district = models.ForeignKey(District, null=True, blank=True, on_delete=models.CASCADE, verbose_name='District of point')
    ...
    def district_name(self):
        if self.district:
            return self.district.name_local
        else:
            return 'Бу фойдаланувчи учун туман белгиланмаган'
